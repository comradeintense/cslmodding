(() => {
			...
			_getObserver() {
				...
				return (e = this._observer) !== null && e !== void 0
					...
					: (this._observer = new ResizeObserver((t) => {
							var s;
							for (let r of t) fe.entries.set(r.target, r), (s = this._listeners.get(r.target)) === null || s === void 0 || s(r);
					  }));
			}
		};
	...
	function ln(n, e, t, s, r, l, i, a, o, h, _, f) {
		...
		for (u = E; u--; ) {
			let F = f(r, l, u),
				U = t(F),
				P = i.get(U);
			P ? s && S.push(() => P.p(F, e)) : ((P = h(U, F)), P.c()), R.set(U, (d[u] = P)), U in m && T.set(U, Math.abs(u - m[U]));
		}
		let w = new Set(),
			B = new Set();
		function X(F) {
	...
	function oe(n, e) {
		let t = n.$$;
		t.fragment !== null && (hs(t.after_update), V(t.on_destroy), t.fragment && t.fragment.d(e), (t.on_destroy = t.fragment = null), (t.ctx = []));
	}
	function ps(n, e) {
		...
		if (
			((h.ctx = t
				? t(n, e.props || {}, (f, c, ...E) => {
						...
						return h.ctx && r(h.ctx[f], (h.ctx[f] = u)) && (!h.skip_bound && h.bound[f] && h.bound[f](u), _ && ps(n, f)), c;
				  })
				: []),
			h.update(),
			(_ = !0),
	...
	var on = ['art-lojban', 'cel-gaulish', 'no-bok', 'no-nyn', 'zh-guoyu', 'zh-hakka', 'zh-min', 'zh-min-nan', 'zh-xiang'];
	var ut = {
	...
	function Qe(n, e = {}) {
		...
		if (l > 1 && l < 9) {
			if (((t.language = s.slice(0, l)), l < 4)) {
				let a = 0;
				for (; r.charCodeAt(l) === 45 && D(r.charCodeAt(l + 1)) && D(r.charCodeAt(l + 2)) && D(r.charCodeAt(l + 3)) && !D(r.charCodeAt(l + 4)); ) {
			...
			for (; r.charCodeAt(l) === 45 && !(r.charCodeAt(l + 1) === 120 || !Y(r.charCodeAt(l + 1)) || r.charCodeAt(l + 2) !== 45 || !Y(r.charCodeAt(l + 3))); ) {
				let a = l + 2,
					o = 0;
	...
	function Rs(n) {
		...
		return {
			...
			m(u, m) {
				c && c.m(u, m), y(u, e, m), y(u, t, m), b(t, s), b(s, r), b(r, i), b(t, o), b(t, h), (h.innerHTML = _), b(t, f), E && E.m(t, null);
			},
			p(u, m) {
	...
	function dn(n) {
		...
		return {
			...
			p(r, l) {
				l & 2 && !le(e.src, (t = r[1].meta?.image)) && p(e, 'src', t), l & 2 && s !== (s = r[1].meta?.image_alt || r[1].meta?.title) && p(e, 'alt', s);
			},
			d(r) {
				r && C(e);
			},
	...
	function mn(n) {
		...
		return {
			c() {
				(e = k('li')), (s = A(t)), (r = A(': ')), (i = A(l)), (a = M()), p(e, 'class', 'pagefind-ui__result-tag svelte-j9e30');
			},
			m(o, h) {
	...
	function ks(n, e, t) {
		let { show_images: s = !0 } = e,
			...
			o = [],
			h = async (f) => {
				t(1, (a = await f.data())), t(1, (a = r?.(a) ?? a)), t(2, (o = Object.entries(a.meta).filter(([c]) => !i.includes(c))));
			},
			_ = (f = 30) => '. '.repeat(Math.floor(10 + Math.random() * f));
		return (
			(n.$$set = (f) => {
				'show_images' in f && t(0, (s = f.show_images)), 'process_result' in f && t(4, (r = f.process_result)), 'result' in f && t(5, (l = f.result));
			}),
			(n.$$.update = () => {
				if (n.$$.dirty & 32) e: h(l);
			}),
	...
	function vn(n) {
		...
		return {
			c() {
				(e = k('li')), (s = A(t)), (r = A(': ')), (i = A(l)), (a = M()), p(e, 'class', 'pagefind-ui__result-tag svelte-4xnkmf');
			},
			m(o, h) {
				y(o, e, h), b(e, s), b(e, r), b(e, i), b(e, a);
			},
	...
	function vs(n, e, t) {
		...
		return (
			(n.$$set = (u) => {
				'show_images' in u && t(0, (s = u.show_images)), 'process_result' in u && t(6, (r = u.process_result)), 'result' in u && t(7, (l = u.result));
			}),
			(n.$$.update = () => {
	...
	function Hn(n) {
		...
		return {
			c() {
				...
				p(t, 'class', 'pagefind-ui__filter-panel-label svelte-1v2r7ls'), p(e, 'class', 'pagefind-ui__filter-panel svelte-1v2r7ls');
			},
			m(o, h) {
	...
	function On(n) {
		...
		return {
			...
			p(s, r) {
				s[2] || s[14] || s[0][`${s[9]}:${s[13]}`] ? (t ? t.p(s, r) : ((t = Nn(s)), t.c(), t.m(e.parentNode, e))) : t && (t.d(1), (t = null));
			},
			d(s) {
				t && t.d(s), s && C(e);
			},
	...
	function jn(n) {
		...
		return {
			...
			p(c, E) {
				if ((E & 2 && s !== (s = c[9].replace(/^(\w)/, zn) + '') && (t.innerHTML = s), E & 2 && a !== (a = c[9] + '') && (i.innerHTML = a), E & 7)) {
	...
	function Ms(n) {
		...
		return {
			...
			p(r, [l]) {
				l & 2 && (e = r[1] && Object.entries(r[1]).length), e ? (s ? s.p(r, l) : ((s = Hn(r)), s.c(), s.m(t.parentNode, t))) : s && (s.d(1), (s = null));
			},
			i: j,
			o: j,
			d(r) {
	...
	var ft = class extends q {
			constructor(e) {
				super(),
					J(this, e, As, Ms, G, { available_filters: 1, show_empty_filters: 2, translate: 3, automatic_translations: 4, translations: 5, selected_filters: 0 });
			}
	...
	var gi = [dt, ht, mt, pt, gt, Et, bt, Rt, Tt, kt, Ct, yt, St, vt, Mt, At, wt, Ft, Ht, Nt, Ot, jt, zt, Dt, Ut, It, Pt, Lt, qt, Bt],
		Un = gi,
		In = [
	...
	function Ln(n) {
		...
		let l = { show_empty_filters: n[4], available_filters: n[16], translate: n[18], automatic_translations: n[17], translations: n[5] };
		return (
	...
	function bi(n) {
		...
		return {
			c() {
				...
				(i = M()), u && u.c(), (a = x()), p(e, 'class', 'pagefind-ui__message svelte-e9gkc3'), p(s, 'class', 'pagefind-ui__results svelte-e9gkc3');
			},
			m(m, d) {
			...
			p(m, d) {
				_ === (_ = h(m, d)) && f ? f.p(m, d) : (f.d(1), (f = _(m)), f && (f.c(), f.m(e, null))),
					d[0] & 34830 && ((c = m[11].results.slice(0, m[15])), ie(), (r = ln(r, d, E, 1, m, c, l, s, rn, Bn, null, Pn)), ae()),
					m[11].results.length > m[15] ? (u ? u.p(m, d) : ((u = Wn(m)), u.c(), u.m(a.parentNode, a))) : u && (u.d(1), (u = null));
			},
			i(m) {
				if (!o) {
	...
	function Ci(n) {
		...
		return {
			...
			p(s, r) {
				r[0] & 147488 && e !== (e = s[18]('zero_results', s[17], s[5]).replace(/\[SEARCH_TERM\]/, s[14]) + '') && N(t, e);
			},
			d(s) {
				s && C(t);
			},
	...
	function yi(n) {
		...
		return (
			(e = new gn({ props: { show_images: n[1], process_result: n[3], result: n[48] } })),
			{
				...
				p(s, r) {
					let l = {};
					r[0] & 2 && (l.show_images = s[1]), r[0] & 8 && (l.process_result = s[3]), r[0] & 34816 && (l.result = s[48]), e.$set(l);
				},
				i(s) {
		...
		return {
			...
			m(T, S) {
				y(T, e, S),
					...
					R && R.m(_, null),
					(E = !0),
					u || ((m = [K(s, 'focus', n[19]), K(s, 'keydown', n[29]), K(s, 'input', n[30]), K(i, 'click', n[33]), K(t, 'submit', Mi)]), (u = !0));
			},
			p(T, S) {
	...
	function Ai(n, e, t) {
		...
		at(() => {
			...
			t(17, (Yt = s[`${H.language}-${H.script}-${H.region}`] || s[`${H.language}-${H.region}`] || s[`${H.language}`] || s.en));
		}),
			ot(() => {
				w?.destroy?.(), (w = null);
			});
...
`)
			...
			Xn = async (g, H) => {
				...
				let O = Yn(H),
					L = () => Zn(g, O);
				u > 0 && g ? (ce && clearTimeout(ce), (ce = setTimeout(L, u)), await Zt(), w.preload(g, { filters: O })) : L(), Qn();
			},
			Zt = async () => {
			...
			Zn = async (g, H) => {
				...
				Gt === O && (L.filters && Object.keys(L.filters)?.length && t(16, (ue = L.filters)), t(11, (P = L)), t(12, (Z = !1)), t(15, (et = i)));
			},
			Qn = () => {
				let g = X.offsetWidth;
		...
		return (
			...
			[a, o, h, f, E, T, S, Ge, B, X, U, P, Z, $e, Kt, et, ue, Yt, Kn, Xt, xn, R, _, l, i, c, u, m, d, $n, es, ts, ns, ss, rs]
		);
	}
